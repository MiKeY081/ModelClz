      ...
      >
        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-xl p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Leadership</h1>
          </div>
          <p className="text-gray-600 text-lg">
            Yo, homie—meet the crew steering the EduExcel ship with mad skills and Homies heart!
          </p>
        </motion.div>

        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Our Leaders</h2>
          <p className="text-gray-600">
            A squad of visionaries—teachers, admins, and Homies who keep the LMS dope and moving forward!
          </p>
        </motion.div>
