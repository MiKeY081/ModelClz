      ...
      >
        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <p className="text-gray-600 text-lg">
            Yo, homie—we use cookies to keep the Homies LMS tasty and smooth. Here’s the scoop!
          </p>
        </motion.div>

        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">What’s a Cookie?</h2>
          <p className="text-gray-600">
            Little bits of data to remember you, homie—makes logging in and vibin’ easier!
          </p>
        </motion.div>

        <motion.div variants={itemVariants} className="bg-white rounded-3xl shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">How We Use ‘Em</h2>
          <p className="text-gray-600">
            To track your journey, keep things secure, and serve up the best Homies experience—no crumbs left behind!
          </p>
        </motion.div>
